...
CREATE OR REPLACE TABLE businessman_notification(
	id INT AUTO_INCREMENT, 
	notificationID INT,
	candidatureID INT,
	CONSTRAINT businessmanNotification_pk PRIMARY KEY(id),
	CONSTRAINT businessmanNotification_notification_fk FOREIGN KEY (notificationID) REFERENCES notification(id) ON DELETE CASCADE,
	CONSTRAINT businessmanNotification_candidature_fk FOREIGN KEY (candidatureID) REFERENCES candidature(id) ON DELETE CASCADE
);
 
CREATE OR REPLACE TABLE worker_notification(
	id INT AUTO_INCREMENT, 
	notificationID INT,
	offerID INT,
	alertID INT,
	CONSTRAINT workerNotification_pk PRIMARY KEY(id),
	CONSTRAINT workerNotification_notification_fk FOREIGN KEY (notificationID) REFERENCES notification(id) ON DELETE CASCADE,
	CONSTRAINT workerNotification_offer_fk FOREIGN KEY (offerID) REFERENCES offer(id) ON DELETE CASCADE,
	CONSTRAINT workerNotification_alert_fk FOREIGN KEY (alertID) REFERENCES alert(id) ON DELETE CASCADE
);
...
INSERT INTO `notification`(`id`, `notified`) VALUES ('1','false');

INSERT INTO `worker_notification`(`notificationID`, `offerID`, `alertID`) VALUES ('1','1','1');
