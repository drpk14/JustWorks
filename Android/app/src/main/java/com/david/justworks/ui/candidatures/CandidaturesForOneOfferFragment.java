...
public class CandidaturesForOneOfferFragment extends Fragment implements CandidatureAdapter.ClickListener {
    ...
    public void onItemClick(View v, int position) {
        ...
        NavHostFragment.findNavController(CandidaturesForOneOfferFragment.this)
                .navigate(R.id.action_nav_candidature_for_one_offer_to_nav_candidature_messages,bundle);
    }
