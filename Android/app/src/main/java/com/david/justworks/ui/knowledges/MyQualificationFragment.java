...
public class MyQualificationFragment extends Fragment implements KnowledgeAdapter.ClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        CommunicationMethods.getInstance().sendMessage(CL_MY_QUALIFICATION);
